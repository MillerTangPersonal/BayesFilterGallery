...
#  0.0222195, 0.0222195, 0.0222195
q1 = Quaternion([0.9998149, 0.0111091, 0.0111091, 0.0111091])
...
dq2 = 2 * Quaternion.log_map(q1_inv, q)

d_theta = np.array([dq2[1], dq2[2], dq2[3]])
dq = Quaternion(zeta(d_theta))

q_po = q1 * dq

# q_po = Quaternion.exp_map(q1, d_theta)

print("q_po is: ",q_po)
print("\n")
print("rotation is: ", q_po.rotation_matrix)

print("\n")
print("q is: ", q)
print("\n")
print("rotation is: ", q.rotation_matrix)
